...
//         <div>
//           <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-50">Tasks</h2>
...
//                   <span>{{ getTotalVisibleTasks() }} / {{ tasks.length }} visible</span>
//                 </div>
            ...
            <header class="mb-3 flex items-center justify-between gap-2">
              ...
              <div class="flex flex-1 flex-wrap items-center justify-end gap-2">
                ...
                >
                  <span class="h-1.5 w-1.5 rounded-full bg-emerald-400"></span>
                  <span
                    >{{ getTotalVisibleTasks() }} / {{ tasks.length }} visible</span
                  >
                </div>
...
export class TasksPageComponent implements OnInit {
  ...
  constructor(
    ...
    private auth: AuthService,
    private orgUsersService: OrgUsersService,
    private toast: ToastService // 👈 toast injected
  ) {}
